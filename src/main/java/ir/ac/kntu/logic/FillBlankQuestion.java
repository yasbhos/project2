...
public class FillBlankQuestion extends Question{
    public FillBlankQuestion(String name, double score, String description, QuestionLevel level, QuestionType type) {
    ...
    public static Question read() {
        ...
        return new FillBlankQuestion(name, score, description, level, QuestionType.FILL_IN_THE_BLANK);
    }
